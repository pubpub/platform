	...
	return (
		...
		>
			...
			<StagePanelSheetContent
				className="[&>button]:!top-5 [&>button]:!right-4 md:[&>button]:!top-8 md:[&>button]:!right-6 overflow-y-auto border-none bg-transparent p-2 shadow-none sm:max-w-lg md:max-w-2xl md:p-6"
