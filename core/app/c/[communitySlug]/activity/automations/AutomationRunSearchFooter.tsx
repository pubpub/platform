...
export const AutomationRunSearchFooter = (
	...
	const { setInputValues } = useAutomationRunSearch()
	...
	return (
		...
		>
			<AutomationRunSearchResultsPerPageInput />
			<Pagination
...
export const AutomationRunSearchResultsPerPageInput = () => {
	const { queryParams, setFilters } = useAutomationRunSearch()
