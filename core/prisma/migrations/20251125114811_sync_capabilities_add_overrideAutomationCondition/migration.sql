...
-- AlterEnum
ALTER TYPE "Capabilities" ADD VALUE 'overrideAutomationConditions';
COMMIT;

-- sync membership capabilities data after enum changes
...
VALUES
    ...
    ('community'::"MembershipType", 'admin'::"MemberRole", 'overrideAutomationConditions'::"Capabilities"),
