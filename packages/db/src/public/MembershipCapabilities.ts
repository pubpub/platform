...
export type MembershipCapabilitiesRole = MemberRole & { __brand: "MembershipCapabilitiesRole" };

/** Identifier type for public.membership_capabilities */
export type MembershipCapabilitiesType = MembershipType & { __brand: "MembershipCapabilitiesType" };

/** Identifier type for public.membership_capabilities */
export type MembershipCapabilitiesCapability = Capabilities & {
	__brand: "MembershipCapabilitiesCapability";
};
