...
export const ICON_MAP = {
	...
	"align-vertical-space-around": Icons.AlignVerticalSpaceAround,
	archive: Icons.Archive,
	"archive-restore": Icons.ArchiveRestore,
	"arrow-left": Icons.ArrowLeft,
	"arrow-right": Icons.ArrowRight,
	"badge-check": Icons.BadgeCheck,
	book: Icons.Book,
	"book-dashed": Icons.BookDashed,
	bookmark: Icons.Bookmark,
	"book-open": Icons.BookOpen,
	"book-open-text": Icons.BookOpenText,
	bot: Icons.Bot,
	"box-select": Icons.BoxSelect,
	...
	"chevrons-up-down": Icons.ChevronsUpDown,
	"circle-check": Icons.CircleCheck,
	"circle-dashed": Icons.CircleDashed,
	"circle-dollar-sign": Icons.CircleDollarSign,
	"circle-dot": Icons.CircleDot,
	"circle-ellipsis": Icons.CircleEllipsis,
	"circle-help": Icons.CircleHelp,
	"circle-slash": Icons.CircleSlash,
	clipboard: Icons.Clipboard,
	"clipboard-pen-line": Icons.ClipboardPenLine,
	cloud: Icons.Cloud,
	contact: Icons.Contact,
	"curly-braces": Icons.CurlyBraces,
	download: Icons.Download,
	ellipsis: Icons.Expand,
	"external-link": Icons.ExternalLink,
	"file-text": Icons.FileText,
	"flag-triangle-right": Icons.FlagTriangleRightIcon,
	...
	"image-plus": Icons.ImagePlus,
	info: Icons.Info,
	"layers-3": Icons.Layers3,
	link: Icons.Link,
	"list-plus": Icons.ListPlus,
	"loader-2": Icons.Loader2,
	lock: Icons.Lock,
	...
	"user-circle-2": Icons.UserCircle2,
	"user-plus": Icons.UserPlus,
	"user-round-cog": Icons.UserRoundCog,
	users: Icons.Users,
