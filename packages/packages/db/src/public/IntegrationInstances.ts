...
export const integrationInstancesIdSchema = z.string().uuid() as unknown as z.Schema<IntegrationInstancesId>;
...
export const integrationInstancesMutatorSchema = z.object({
  ...
  stageId: stagesIdSchema.optional().nullable(),
  config: z.unknown().optional().nullable(),
}) as z.ZodObject<{[K in keyof IntegrationInstancesUpdate]: z.Schema<IntegrationInstancesUpdate[K]>}>;
