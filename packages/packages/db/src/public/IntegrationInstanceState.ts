...
export const integrationInstanceStateInitializerSchema = z.object({
  ...
  instanceId: integrationInstancesIdSchema,
  state: z.unknown(),
}) as z.ZodObject<{[K in keyof NewIntegrationInstanceState]: z.Schema<NewIntegrationInstanceState[K]>}>;
...
}) as z.ZodObject<{[K in keyof IntegrationInstanceStateUpdate]: z.Schema<IntegrationInstanceStateUpdate[K]>}>;
