			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "Ticks as treasure troves: Molecular discovery in new organisms",
						},
					],
				},
			},
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "Robust long-read saliva transcriptome and proteome from the lone star tick, Amblyomma americanum",
						},
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "De novo assembly of a long-read Amblyomma americanum tick genome",
						},
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "Performing mass spectrometry-based proteomics in organisms with minimal reference protein databases",
						},
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "Genetics: Decoding evolutionary drivers across biology",
						},
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "Distinct spatiotemporal movement properties reveal sub-modalities in crawling cell types",
						},
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "Raman spectra reflect complex phylogenetic relationships",
						},
						{ fieldId: fieldIds[6], value: topPub2.id },
					],
				},
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "Phenotypic differences between interfertile Chlamydomonas species",
						},
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "Designing genome-wide MERFISH probes for understudied species",
						},
						{ fieldId: fieldIds[5], value: "Xiao-Li Meng" },
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "A workflow to isolate phage DNA and identify nucleosides by HPLC and mass spectrometry",
						},
						// { fieldId: fieldIds[5], value: "Xiao-Li Meng" },
			...
			values: {
				createMany: {
					data: [
						{
							fieldId: fieldIds[0],
							value: "Microchamber slide design for cell confinement during imaging",
						},
						// { fieldId: fieldIds[5], value: "Xiao-Li Meng" },
